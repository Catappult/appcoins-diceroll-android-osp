...
import com.appcoins.diceroll.osp.core.ui.design.theme.DiceRollTheme
...
import com.appcoins.diceroll.osp.feature.roll_game.ui.R as GameR
...
fun RollGameContent(
  ...
  Column(
    ...
    Button(
      ...
      Text(
        text = stringResource(id = R.string.roll_game_buy_button) /* + TODO Add Price Request (attemptsPrice?.let { " $it" } ?: "")*/,
        textAlign = TextAlign.Center
      )
    }
  }
